...
class ItemDetails extends React.Component{
    ...
    renderField =({label, type, input, meta:{touched, error}})=>(
        <div>
            <Input {...input} type={type} className="form-control" id="delivery_pincode"  placeholder={label} />
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <form onSubmit={handleSubmit(this.submitData)}>
                                                                            <Field name="DeliveryPin" type="text" component={this.renderField} label='Enter Delivery Pincode' />
                                                                            <a href="javascript:void(0);" onSubmit={handleSubmit(this.submitData)} class="w-check-pin">Check Now</a>
                                                                        </form>
                                                                        </div>
                                                                    </div>
                                                                </div>
